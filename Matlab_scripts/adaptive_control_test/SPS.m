classdef SPS
    ...
    methods
        ...
        function is_in_conf_region = sps_indicator(obj, y,u, A_star, B_star, C_star, D_star, controller, controller_args, createFeatureMatrix)
            ...
            armaxGen_bar = ARMAXGenerator(A_star, B_star, C_star, D_star, controller, controller_args);
